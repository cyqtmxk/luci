...
o.default     = "/etc/AdGuardHome/data"
o.datatype    = "string"
o.optional = false
o.rmempty=false
o.validate=function(self, value)
...
local workdir=uci:get("AdGuardHome","AdGuardHome","workdir") or "/ect/AdGuardHome/work_backup"
...
o1.default     = "/etc/AdGuardHome/work_backup"
o1.datatype    = "string"
o1.optional = false
